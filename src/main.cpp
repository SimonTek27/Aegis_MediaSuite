...
private:
    static Aegis::AppMode detectModeFromBinary(const QString &argv0) {
        ...
        static const QHash<QString, Aegis::AppMode> modeMap = {
            ...
            {"aegis_mplayer",     Aegis::AppMode::MediaPlayer},
            ...
            {"aegis_midsound",  Aegis::AppMode::MiddlewareEditor},
            {"aegis_midstudio", Aegis::AppMode::MiddlewareEditor},
            {"aegis_modtrack",  Aegis::AppMode::MiddlewareEditor},
    ...
    static Aegis::AppMode stringToMode(const QString &modeStr) {
        static const QHash<QString, Aegis::AppMode> modeMap = {
            ...
            {"middleware", Aegis::AppMode::MiddlewareEditor},
            {"scundmod",   Aegis::AppMode::MiddlewareEditor},
...
public:
    ...
    static void registerQmlTypes() {
        ...
        qmlRegisterType<MiddlewareEditor>("Aegis.SoundMod", 1, 0, "MiddlewareEditor");
...
private:
    ...
    static QString modeToString(Aegis::AppMode mode) {
        switch (mode) {
            ...
            case Aegis::AppMode::Launcher:            return "launcher";
