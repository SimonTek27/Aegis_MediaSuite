...
// ─────────────────────────────────────────────────────────────────────────────
// Composite runner
// Uses QGuiApplication (not QCoreApplication) because QQmlEngine / QtQuick
// require a GUI application context to initialise the rendering infrastructure.
// Without this, the vtable for QObject-derived classes used by QQmlEngine is
// not fully resolved at link time and the linker emits "undefined reference to
// vtable for TestQmlComponentLoading".
// ─────────────────────────────────────────────────────────────────────────────
#ifndef AEGIS_VERSION
#  define AEGIS_VERSION "2.1.1"
#endif
...
int main(int argc, char** argv) {
    QGuiApplication app(argc, argv);   // ← QGuiApplication, not QCoreApplication
    int result = 0;
    {
